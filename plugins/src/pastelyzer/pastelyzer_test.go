...
func TestConvert(t *testing.T) {
	...
	tables := []struct {
		...
		{`SELECT * WHERE ip='10.10.10.10'`, [][2]string{[2]string{"ip", "10.10.10.10"}}},
		{`select * where name='sarah' and age=40 limit 0,1`, [][2]string{[2]string{"name", "sarah"}, [2]string{"age", "40"}, [2]string{"limit", "1"}}},
	}
